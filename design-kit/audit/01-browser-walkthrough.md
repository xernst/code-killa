...
- **Two ember tones in use** — `rgb(242, 104, 60)` (#2aa06a, the spec accent) AND `rgb(227, 76, 28)` (deeper) AND `rgb(249, 139, 105)` (lighter hover). Spec says ember is the *only* accent — strict reading would mean one tone. Evidence: getComputedStyle probe.
