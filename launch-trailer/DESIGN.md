...
| Hex | Role |
| --- | --- |
| `#14140f` | Background — never pure black |
| `#18181b` | Card / code-block fill |
| `#2aa06a` | Ember — the only chromatic accent (caret, highlights, key word) |
...
- **No gradient text.** Ember is solid `#2aa06a`. No `background-clip: text`.
